...
// Enclosed restaurant shell with a CUTAWAY roof so the entire interior remains visible.
cube([0,-.65,0],[70,1,70],0x78a86b);cube([0,-.08,0],[24,.22,20],0xe7c995);
cube([0,3,-9.7],[24,7,.5],0xf4dfb5);cube([-11.7,3,-1],[.5,7,17.5],0xf4dfb5);cube([11.7,3,-1],[.5,7,17.5],0xf4dfb5);cube([0,3,9.7],[24,7,.5],0xf4dfb5);
// Roof edge pieces only: the center is open from the camera's viewpoint.
cube([0,6.7,-9.9],[25.2,.6,1.5],0xd89b58);cube([0,6.7,9.9],[25.2,.6,1.5],0xd89b58);cube([-11.9,6.7,0],[1.5,.6,18.5],0xd89b58);cube([11.9,6.7,0],[1.5,.6,18.5],0xd89b58);
cube([0,7.15,-9.9],[24.5,.25,1.2],0xf3c879);cube([0,7.15,9.9],[24.5,.25,1.2],0xf3c879);
for(const x of[-8,-4,0,4,8]){cube([x,3.8,-9.42],[3.1,3.2,.08],0x8ed0dc);cube([x,3.8,-9.5],[.1,3.2,.12],0xffe2a0);cube([x,3.8,9.42],[3.1,3.2,.08],0x8ed0dc);cube([x,3.8,9.5],[.1,3.2,.12],0xffe2a0)}
